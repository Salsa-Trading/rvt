      ...
      <BrowserRouter>
        <div id='rvt-demo'>
          ...
          <main>
            ...
            <Route path='/examples/variableRowHeight' component={VariableRowHeight} />
            ...
            <Route path='/examples/streamingVariableRowGrid' component={() => <StreamingVariableRowGrid variableRowHeight={false}/>} />
          </main>
        </div>
      </BrowserRouter>
    );
